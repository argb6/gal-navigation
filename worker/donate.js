...
const CONTACT_MAILTO = "mailto:contact@example.com";
...
function renderDonorsSection(donors) {
  const count = donors.length ? '<span class="gd-section__count">' + donors.length + '</span>' : "";
  const rows = donors.length ? donors.map(renderDonorRow).join("") : '<tr><td colspan="4">暂无捐赠记录</td></tr>';
  return '<section class="gd-section" id="donors"><h2 class="gd-section__title">捐款名单' + count + '</h2><div class="gd-donate-table-wrap"><table class="gd-donate-table" aria-label="捐款名单"><thead><tr><th scope="col">昵称</th><th scope="col">金额</th><th scope="col">备注</th><th scope="col">日期</th></tr></thead><tbody>' + rows + '</tbody></table></div></section>';
}
...
<link rel="apple-touch-icon" href="${ASSET_ICON}"><style>
/* ===== 组件库（构建期内联） ===== */
...
/* ===== src/extend/donate/gd-donate.css ===== */
/* gd-donate — 页面示例：扫码卡 / 捐献名单 */
...
.gd-donate-card {
  ...
  -webkit-backdrop-filter: none;
  font-family: var(--gd-font-sans);
  transition: background 0.25s var(--gd-motion-easing-standard), border-color 0.25s var(--gd-motion-easing-standard);
}
.gd-donate-card:hover {
  background: var(--gd-glass-bg-hover);
  border-color: var(--gd-color-border-hover);
}

.gd-donate-card__label {
  font-size: var(--gd-type-title-small-size);
  font-weight: var(--gd-weight-bold);
  color: var(--gd-color-on-surface);
}
...
.gd-donate-card__qr {
  ...
  object-fit: contain;
  border-radius: 12px;
  background: var(--gd-color-on-primary);
  padding: 8px;
  display: block;
}

/* 无真实收款码时的预留方块 */
.gd-donate-card__slot {
  width: 180px;
  height: 180px;
  border-radius: 12px;
  background: rgba(var(--gd-color-ink-4-rgb), 0.72);
  border: 1px dashed rgba(var(--gd-color-grey-rgb), 0.56);
  padding: 8px;
  display: flex;
  align-items: center;
  justify-content: center;
...
.gd-donate-card--empty {
  min-height: 220px;
  justify-content: center;
}

.gd-donate-card__hint {
  margin: 0;
  color: var(--gd-color-on-surface-variant);
  font-size: var(--gd-type-label-large-size);
  line-height: 1.6;
...
.gd-donate-table-wrap {
  overflow-x: auto;
  -webkit-overflow-scrolling: touch;
  scrollbar-width: none;
  -ms-overflow-style: none;
}
.gd-donate-table-wrap::-webkit-scrollbar {
  width: 0;
  height: 0;
  background: transparent;
}
...
.gd-donate-table td {
  padding: 12px 14px;
  text-align: left;
  border-bottom: 1px solid rgba(var(--gd-color-white-rgb), 0.08);
  vertical-align: top;
}

.gd-donate-table thead th {
  font-size: var(--gd-type-note-size);
  font-weight: var(--gd-weight-bold);
  color: var(--gd-color-on-surface-variant);
  letter-spacing: var(--gd-type-letter-spacing-wide);
  border-bottom-color: rgba(var(--gd-color-white-rgb), 0.14);
  white-space: nowrap;
}

.gd-donate-table tbody td {
  color: var(--gd-color-on-surface-variant);
  line-height: 1.55;
}

.gd-donate-table tbody td:first-child {
  color: var(--gd-color-on-surface);
  font-weight: var(--gd-weight-bold);
}

.gd-donate-table tbody tr:hover td {
  background: rgba(var(--gd-color-white-rgb), 0.03);
}

.gd-donate-table tbody tr:last-child td {
  border-bottom: 0;
}
...
.gd-overview__content .card strong,
.gd-overview__content .card em {
  color: var(--gd-color-link);
  font-weight: var(--gd-weight-semibold);
  font-style: normal;
}
...
.gd-overview__content .gd-donate-grid { margin-top: 4px; }
.gd-overview__content .gd-donate-table-wrap { padding-top: 4px; }
.gd-donate-note {
  margin: 14px 0 0;
  font-family: var(--gd-font-sans);
  font-size: var(--gd-type-label-large-size);
...
/* gd-donate 卡片在窄屏宽度自适应 */
@media (max-width: 640px) {
  .gd-overview__content .gd-donate-card { width: 100%; }
}
...
<div class="gd-overview__shell">
  <div class="gd-overview__layout">
    <main class="gd-overview__content" id="main-content">
      <div class="gd-overview-toc-mobile" data-extend-ui-toc>
        <button type="button" class="gd-overview-toc-mobile__btn gd-hamburger-motion" data-extend-ui-toc-toggle aria-expanded="false" aria-controls="donateTocPanel" aria-label="打开本页索引">
        ...
        <div class="gd-overview-toc-mobile__panel" id="donateTocPanel" data-extend-ui-toc-panel aria-hidden="true" hidden>
          <p class="gd-overview-mobile-list__label">本页内容</p>
          <nav class="gd-overview-mobile-list" aria-label="本页索引">
            <a class="gd-overview-mobile-list__link" href="#why">为何支持</a>
            <a class="gd-overview-mobile-list__link" href="#qr">扫码支持</a>
            <a class="gd-overview-mobile-list__link" href="#ways">其他方式</a>
            <a class="gd-overview-mobile-list__link" href="#donors">捐款名单</a>
            <a class="gd-overview-mobile-list__link" href="#note">说明</a>
          </nav>
        </div>
      </div>
      <h1 class="gd-brand__title gd-brand__title--shift gd-brand__title--demo">捐献</h1>
      <p class="gd-overview__lede">支持 GALNAVI 资源中枢的日常维护。自愿捐献，感谢每一份心意。</p>
      <div class="gd-overview__meta">
        <span class="gd-overview__tag">自愿捐献</span>
        <span class="gd-overview__tag">感谢支持</span>
      </div>
      <div class="gd-overview__rule" aria-hidden="true"></div>

<section class="gd-section" id="why">
  <h2 class="gd-section__title">为何支持</h2>
  <div class="card">
    <ul>
...
<section class="gd-section" id="qr">
  <h2 class="gd-section__title">扫码支持</h2>
  <div class="gd-donate-grid">
    ${renderQrCard("支付宝", QR_ALIPAY)}
    ${renderQrCard("微信", QR_WECHAT)}
  </div>
  <p class="gd-donate-note">相关信息请在付款界面备注</p>
</section>
<section class="gd-section" id="ways">
...
${renderDonorsSection(donors)}
<section class="gd-section" id="note">
  <h2 class="gd-section__title">说明</h2>
  <div class="card">
    <p>请确认你正在官方域名 example.com 上操作。本页不会通过弹窗、私信或不明链接索要转账。未成年人请在监护人同意下再考虑支持。感谢每一位愿意支持 GALNAVI 的朋友。</p>
  </div>
</section>

<div class="gd-overview__rule" aria-hidden="true"></div>
<footer class="gd-footer"><nav class="gd-footer__nav" aria-label="页脚链接"><a href="https://example.com/sitemap.xml">sitemap.xml</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://example.com/robots.txt">robots.txt</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="mailto:contact@example.com">联系站长</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://example.com/nav/donate/">赞助本站</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://example.com/nav/friend/">申请友链</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://example.com/status/">站点状态</a></nav><p class="gd-footer__copy">© 2026 GALNAVI · 愿每一次探索都有新的收获</p></footer>
    </main>
<aside class="gd-overview__toc" aria-label="本页内容">
  <nav class="gd-otp" aria-label="本页索引">
    ...
    <div class="gd-otp__list">
      <a class="gd-otp__link" href="#why">为何支持</a>
      <a class="gd-otp__link" href="#qr">扫码支持</a>
      <a class="gd-otp__link" href="#ways">其他方式</a>
      <a class="gd-otp__link" href="#donors">捐款名单</a>
      <a class="gd-otp__link" href="#note">说明</a>
    </div>
  </nav>
</aside>
  </div>
...
<script>
/* 首访检测（与 friend/palace 同款）：未访问过 GALNAVI 的用户跳转主站（cookie+localStorage） */
(function(){
