...
<link rel="icon" type="image/png" href="https://your-cdn.example.com/assets/icon/favicon.png">
...
.gd-brand__title {
  display: inline-block; max-width: 100%; margin: 0; padding: 0;
  font-family: var(--gd-font-sans); font-size: clamp(var(--gd-type-display-small-size), 6vw, 52px);
  line-height: 1.35; font-weight: var(--gd-weight-black); letter-spacing: var(--gd-type-letter-spacing-wide);
  color: var(--gd-color-primary); text-shadow: 0 0 20px rgba(var(--gd-color-primary-rgb), 0.45);
  animation: gd-brand-glow 3s linear infinite;
}
@keyframes gd-brand-glow {
  0% { color: var(--gd-color-primary); text-shadow: 0 0 18px rgba(var(--gd-color-primary-rgb), 0.48); }
  16.67% { color: rgba(var(--gd-color-sky-rgb), 0.78); text-shadow: 0 0 18px rgba(var(--gd-color-sky-rgb), 0.4); }
  33.33% { color: var(--gd-color-cyan); text-shadow: 0 0 16px rgba(var(--gd-color-cyan-rgb), 0.36); }
  50% { color: var(--gd-color-cyan-light); text-shadow: 0 0 14px rgba(var(--gd-color-cyan-light-rgb), 0.28); }
  66.67% { color: rgba(var(--gd-color-sky-blue-rgb), 0.7); text-shadow: 0 0 16px rgba(var(--gd-color-sky-blue-rgb), 0.38); }
  83.33% { color: var(--gd-color-secondary); text-shadow: 0 0 20px rgba(var(--gd-color-secondary-rgb), 0.48); }
  100% { color: var(--gd-color-primary); text-shadow: 0 0 18px rgba(var(--gd-color-primary-rgb), 0.48); }
}
...
@keyframes gd-brand-glow-palace {
  0% { color: rgba(var(--gd-color-green-rgb), 1); text-shadow: 0 0 18px rgba(var(--gd-color-green-rgb), 0.4); }
  33.33% { color: rgba(var(--gd-color-error-rgb), 1); text-shadow: 0 0 18px rgba(var(--gd-color-error-rgb), 0.45); }
  66.67% { color: rgba(var(--gd-color-gold-deep-rgb), 1); text-shadow: 0 0 18px rgba(var(--gd-color-gold-deep-rgb), 0.45); }
  100% { color: rgba(var(--gd-color-gold-deep-rgb), 1); text-shadow: 0 0 18px rgba(var(--gd-color-gold-deep-rgb), 0.45); }
}
...
.gd-groundback--blue {
  background: radial-gradient(circle at 22% 18%, rgba(var(--gd-color-blue-rgb), 0.2), transparent 34%),
...
.gd-groundback--blue::after {
  background: linear-gradient(90deg, transparent, rgba(var(--gd-color-white-rgb), 0.028), transparent),
...
.gd-groundback--gold::before {
  background: radial-gradient(40% 35% at 18% 14%, rgba(var(--gd-color-gold-rgb), 0.12), transparent 70%),
    radial-gradient(36% 32% at 86% 82%, rgba(var(--gd-color-error-rgb), 0.10), transparent 70%);
}

/* ===== src/extend/overview/gd-overview.css ===== */
:root {
  --ov-bg: var(--gd-color-background); --ov-text: var(--gd-color-on-surface);
  --ov-display: var(--gd-color-on-surface); --ov-tertiary: var(--gd-color-on-surface-variant);
  --ov-anchor: rgba(139, 156, 192, 0.55); --ov-accent: var(--gd-color-primary);
  --ov-border-soft: rgba(var(--gd-color-white-rgb), 0.14); --ov-toc-width: 165px;
  --ov-content-max: 811px; --ov-page-max: 976px; --ov-shell-pad-right: 12px;
}
html { scroll-behavior: smooth; background: var(--gd-color-background); }
body.gd-overview {
  margin: 0; min-height: 100%; color: var(--gd-color-on-surface); font-family: var(--gd-font-sans);
  text-rendering: optimizeLegibility; -webkit-font-smoothing: antialiased;
  background: radial-gradient(40% 35% at 18% 12%, rgba(var(--gd-color-indigo-rgb), 0.3), transparent 70%),
    radial-gradient(35% 30% at 88% 78%, rgba(var(--gd-color-blue-deep-rgb), 0.22), transparent 70%), var(--gd-color-background);
  background-attachment: fixed;
}
.gd-overview__chrome { height: 1px; width: 100%; background-image: url("data:image/svg+xml;base64,"); background-repeat: repeat-x; background-position: 0 0; }
.gd-overview__shell { width: 100%; max-width: none; margin: 0; box-sizing: border-box; }
.gd-overview__layout { display: grid; grid-template-columns: minmax(0, 1fr); grid-template-areas: "post"; width: 100%; }
.gd-overview__content { grid-area: post; min-width: 0; padding: 24px 20px 64px; }
.gd-overview__toc { display: none; grid-area: toc; }
@media (min-width: 768px) {
  .gd-overview__shell { padding-right: var(--ov-shell-pad-right); padding-left: 0; }
  .gd-overview__layout { grid-template-columns: minmax(0, 1fr) var(--ov-toc-width); grid-template-areas: "post toc"; }
  .gd-overview__content { padding: 24px 28px 80px clamp(20px, 3vw, 48px); }
  .gd-overview__toc { display: block; padding: 28px 8px 0 12px; background-image: url("data:image/svg+xml;base64,"); background-repeat: repeat-y; background-position: 0 0; }
}
@media (min-width: 1280px) { :root { --ov-toc-width: 165px; } }
.gd-overview__date { display: block; font-family: var(--gd-font-sans); font-size: var(--gd-type-label-medium-size); font-weight: var(--gd-weight-medium); line-height: 1; letter-spacing: var(--gd-type-letter-spacing-wide); text-transform: uppercase; color: var(--gd-color-on-surface-variant); margin: 0 0 16px; }
.gd-overview__title { display: inline-block; margin: 0 0 20px; padding: 0; font-family: var(--gd-font-sans); font-size: clamp(var(--gd-type-display-small-size, 28px), 6vw, 52px); font-weight: var(--gd-weight-black); line-height: 1.35; letter-spacing: var(--gd-type-letter-spacing-wide); color: rgba(var(--gd-color-sky-blue-rgb), 0.9); text-shadow: 0 0 24px rgba(var(--gd-color-sky-blue-rgb), 0.35); animation: gd-brand-glow 3s linear infinite; }
.gd-overview__lede { margin: 0 0 8px; max-width: 40rem; font-family: var(--gd-font-sans); font-size: var(--gd-type-body-medium-size, 16px); line-height: 1.7; color: var(--gd-color-on-surface-variant); }
.gd-overview__meta { display: flex; flex-wrap: wrap; gap: 8px 12px; align-items: center; margin: 20px 0 0; font-size: var(--gd-type-note-size); color: var(--ov-tertiary); }
.gd-overview__tag { display: inline-flex; align-items: center; padding: 4px 10px; border-radius: 999px; border: 1px solid color-mix(in oklab, var(--ov-text) 18%, transparent); color: var(--ov-tertiary); font-size: var(--gd-type-note-size); line-height: 1.3; text-decoration: none; }
.gd-overview__rule { height: 1px; margin: 40px 0 8px; background-image: url("data:image/svg+xml;base64,"); background-repeat: repeat-x; background-position: 0 0; }
.gd-overview .gd-section { margin: 40px 0 0; padding-top: 8px; scroll-margin-top: 24px; }
.gd-overview .gd-section__title { margin: 0 0 16px; font-family: var(--gd-font-sans); font-size: var(--gd-type-title-xxl-size); font-weight: var(--gd-weight-bold); line-height: 1.25; color: var(--gd-color-on-surface); gap: 0; }
.gd-overview .gd-section__title::before { display: none; }
.gd-overview .demo-note { margin: 0 0 12px; font-family: var(--gd-font-sans); font-size: var(--gd-type-body-medium-size, 15px); line-height: 1.7; color: var(--gd-color-on-surface-variant); }
.gd-overview .demo-note--no-margin { margin-bottom: 0; }
.gd-overview .demo-note--top { margin: 16px 0 0; }
.gd-overview .demo-preview { margin-top: 12px; padding: 20px; border-radius: 8px; border: 1px dashed rgba(var(--gd-color-grey-rgb), 0.45); background: rgba(var(--gd-color-white-rgb), 0.02); }
.gd-overview .demo-preview + .demo-preview { margin-top: 16px; }
.gd-overview .demo-preview--pad-bottom { padding-bottom: 28px; }
.gd-overview .demo-preview--groundback { position: relative; overflow: hidden; transform: translateZ(0); aspect-ratio: 16 / 9; display: flex; align-items: flex-end; }
.gd-overview .groundback-demo-label { margin: 0; padding: 10px 14px; border-radius: 8px; background: rgba(var(--gd-color-navy-rgb), 0.55); border: 1px solid rgba(var(--gd-color-white-rgb), 0.14); font-size: var(--gd-type-note-size); color: var(--gd-color-on-surface); }
.gd-overview .is-hidden { display: none; }
.gd-overview .extend-ui-demo { display: grid; grid-template-columns: minmax(0, 1fr) 190px; gap: 18px; }
.gd-overview .extend-ui-demo__main { min-width: 0; }
.gd-overview .extend-ui-demo__toc-mobile { display: none; position: relative; width: fit-content; margin: 8px 8px 14px auto; }
.gd-overview .extend-ui-demo__toc-mobile .gd-overview-toc-mobile__panel { position: absolute; top: calc(100% + 4px); right: 0; width: min(88vw, 280px); max-height: min(72vh, 480px); overflow-x: hidden; overflow-y: auto; padding: 12px 8px; border-radius: var(--gd-shape-corner-small); border: 1px solid rgba(var(--gd-color-grey-rgb), 0.28); background: rgba(var(--gd-color-ink-3-rgb), 0.94); backdrop-filter: blur(18px) saturate(160%); -webkit-backdrop-filter: blur(18px) saturate(160%); box-shadow: 0 12px 36px rgba(0, 0, 0, 0.4); scrollbar-width: none; -ms-overflow-style: none; visibility: hidden; opacity: 0; pointer-events: none; transform: translateY(-10px) scale(0.96); transform-origin: top right; transition: opacity 0.24s cubic-bezier(0.4, 0, 0.2, 1), transform 0.28s cubic-bezier(0.4, 0, 0.2, 1), visibility 0.28s; }
.gd-overview .extend-ui-demo__toc-mobile.is-open .gd-overview-toc-mobile__panel { visibility: visible; opacity: 1; pointer-events: auto; transform: translateY(0) scale(1); }
.gd-overview .extend-ui-demo__toc { padding-left: 16px; border-left: 1px dashed rgba(var(--gd-color-grey-rgb), 0.5); }
@media (max-width: 767px) { .gd-overview .extend-ui-demo { grid-template-columns: minmax(0, 1fr); } .gd-overview .extend-ui-demo__toc-mobile { display: block; } .gd-overview .extend-ui-demo__toc { display: none; } }
.gd-overview .demo-preview__bar { display: flex; flex-wrap: wrap; gap: 12px; align-items: center; justify-content: space-between; margin-bottom: 12px; }
.gd-overview .demo-preview__label { font-size: var(--gd-type-note-size); color: var(--ov-tertiary); margin-bottom: 10px; }
.gd-overview .demo-row { display: flex; flex-wrap: wrap; gap: 12px; align-items: center; margin-top: 12px; }
.gd-overview .demo-row--no-margin { margin-top: 0; }
.gd-overview .demo-navbar-stage { border-radius: 8px; overflow: hidden; border: 1px solid rgba(var(--gd-color-primary-rgb), 0.12); }
.gd-overview .demo-navbar-stage .gd-navbar { position: relative; }
.gd-overview .gd-footer { margin-top: 56px; padding-top: 24px; border-top: none; }
.gd-overview .gd-footer--page { background-image: url("data:image/svg+xml;base64,"); background-repeat: repeat-x; background-position: 0 0; }
.gd-otp { position: sticky; top: 40px; z-index: 1; padding-bottom: 48px; }
.gd-otp__label { margin: 0 0 10px 10px; font-family: var(--gd-font-sans); font-size: var(--gd-type-label-medium-size); font-weight: var(--gd-weight-semibold); line-height: 1; letter-spacing: var(--gd-type-letter-spacing-wide); text-transform: uppercase; color: var(--gd-color-on-surface-variant); }
.gd-otp__list { display: flex; flex-direction: column; position: relative; margin: 0; padding: 0; list-style: none; max-height: calc(100vh - 120px); overflow-y: auto; scrollbar-width: none; -ms-overflow-style: none; }
.gd-otp__list::-webkit-scrollbar { width: 0; height: 0; background: transparent; }
.gd-otp__link { display: block; position: relative; padding: 6px 2px 6px 14px; color: var(--gd-color-on-surface-variant); font-family: var(--gd-font-sans); font-size: 13.5px; line-height: 1.35; text-decoration: none; transition: color 0.14s ease; }
.gd-otp__link::before { content: ""; position: absolute; left: 7px; top: 0; bottom: 0; width: 1px; background: var(--ov-anchor); opacity: 0.55; }
.gd-otp__link:hover { color: var(--gd-color-on-surface); }
.gd-otp__link.is-active { color: var(--gd-color-link-hover); font-weight: var(--gd-weight-semibold); }
.gd-otp__link.is-active::before { background: var(--gd-color-primary); opacity: 1; width: 2px; left: 6.5px; }
.gd-overview-toc-mobile { display: none; }
.gd-overview-toc-mobile__btn { width: 44px; height: 44px; border: 1px solid rgba(var(--gd-color-grey-rgb), 0.32); border-radius: 12px; background: rgba(var(--gd-color-ink-rgb), 0.9); box-shadow: none; color: var(--gd-color-on-surface); display: inline-flex; align-items: center; justify-content: center; cursor: pointer; padding: 0; position: relative; transition: color 0.2s ease, background-color 0.2s ease, border-color 0.2s ease, transform 0.2s ease; }
.gd-overview-toc-mobile__btn:hover { color: var(--gd-color-primary); background: rgba(var(--gd-color-ink-2-rgb), 0.92); border-color: rgba(var(--gd-color-outline-blue-rgb), 0.56); }
.gd-overview-toc-mobile__btn:active { transform: scale(0.92); }
.gd-overview-toc-mobile__btn:focus-visible { outline: 2px solid var(--gd-color-primary); outline-offset: 2px; }
.gd-overview-toc-mobile__btn svg { inset: 50% auto auto 50%; }
.gd-otp__link { transition: color 0.2s ease, font-weight 0.2s ease, background-color 0.2s ease; }
.gd-otp__link::before { transition: background-color 0.2s ease, width 0.2s ease, opacity 0.2s ease; }
@media (max-width: 767px) {
  .gd-overview__content { padding-top: 56px; }
  .gd-overview-toc-mobile { display: block; position: fixed; top: 8px; right: 8px; z-index: 300; }
  .gd-overview-toc-mobile__panel { position: absolute; top: calc(100% + 4px); right: 0; width: min(88vw, 280px); max-height: min(72vh, 480px); overflow-x: hidden; overflow-y: auto; padding: 12px 8px; border-radius: 12px; border: 1px solid rgba(var(--gd-color-grey-rgb), 0.28); background: rgba(var(--gd-color-ink-3-rgb), 0.94); backdrop-filter: blur(18px) saturate(160%); -webkit-backdrop-filter: blur(18px) saturate(160%); box-shadow: 0 12px 36px rgba(0, 0, 0, 0.4); scrollbar-width: none; -ms-overflow-style: none; visibility: hidden; opacity: 0; pointer-events: none; transform: translateY(-10px) scale(0.96); transform-origin: top right; transition: opacity 0.24s cubic-bezier(0.4, 0, 0.2, 1), transform 0.28s cubic-bezier(0.4, 0, 0.2, 1), visibility 0.28s; }
  .gd-overview-toc-mobile__panel::-webkit-scrollbar { display: none; width: 0; height: 0; }
  .gd-overview-toc-mobile.is-open .gd-overview-toc-mobile__panel { visibility: visible; opacity: 1; pointer-events: auto; transform: translateY(0) scale(1); }
  .gd-overview-mobile-list__label { margin: 0 8px 8px; font-size: var(--gd-type-label-small-size); font-weight: var(--gd-weight-bold); letter-spacing: var(--gd-type-letter-spacing-wide); text-transform: uppercase; color: var(--gd-color-on-surface-variant); opacity: 0; transform: translateY(6px); transition: opacity 0.22s ease, transform 0.22s ease; }
  .gd-overview-toc-mobile.is-open .gd-overview-mobile-list__label { opacity: 1; transform: none; transition-delay: 40ms; }
  .gd-overview-mobile-list { display: flex; flex-direction: column; gap: 2px; margin: 0; padding: 0; }
  .gd-overview-mobile-list__link { display: block; width: 100%; box-sizing: border-box; padding: 10px 12px; border-radius: 8px; color: var(--gd-color-on-surface-variant); font-family: var(--gd-font-sans); font-size: var(--gd-type-label-large-size); font-weight: var(--gd-weight-medium); line-height: 1.35; text-decoration: none; text-align: left; opacity: 0; transform: translateY(8px); transition: opacity 0.22s ease, transform 0.24s cubic-bezier(0.4, 0, 0.2, 1), color 0.18s ease, background-color 0.18s ease; }
  .gd-overview-toc-mobile.is-open .gd-overview-mobile-list__link { opacity: 1; transform: none; }
  ...
  .gd-overview-mobile-list__link:hover { color: var(--gd-color-on-surface); background: rgba(var(--gd-color-white-rgb), 0.05); }
  .gd-overview-mobile-list__link.is-active { color: var(--gd-color-link-hover); background: var(--gd-color-primary-container); font-weight: var(--gd-weight-bold); }
  .gd-otp__link:focus-visible, .gd-overview-mobile-list__link:focus-visible { outline: 2px solid var(--gd-color-link); outline-offset: 2px; }
}
@media (prefers-reduced-motion: reduce) { .gd-overview-toc-mobile__btn, .gd-overview-toc-mobile__btn svg, .gd-overview-toc-mobile__panel, .gd-overview-mobile-list__label, .gd-overview-mobile-list__link, .gd-otp__link, .gd-otp__link::before { transition: none !important; } }
...
.gd-link { display: inline; background: transparent; border: none; font-family: var(--gd-font-sans); font-size: var(--gd-type-body-medium-size); font-weight: var(--gd-weight-semibold); line-height: inherit; text-decoration: none; cursor: pointer; color: var(--gd-color-link); transition: color var(--gd-motion-duration-short4) var(--gd-motion-easing-standard); }
.gd-link:hover { color: var(--gd-color-link-hover); text-decoration: underline; text-underline-offset: 4px; }
.gd-link:focus-visible { outline: 2px solid var(--gd-color-primary); outline-offset: 2px; border-radius: 2px; }
.gd-link:disabled, .gd-link[aria-disabled="true"] { opacity: var(--gd-state-disabled); pointer-events: none; cursor: not-allowed; }

/* ===== src/display/tag/gd-tag.css ===== */
.gd-tag { display: inline-flex; align-items: center; justify-content: center; box-sizing: border-box; height: 30px; padding: 0 14px; border-radius: var(--gd-shape-corner-full); font-family: var(--gd-font-sans); font-size: var(--gd-type-label-large-size); font-weight: var(--gd-weight-medium); line-height: 1; cursor: pointer; user-select: none; transition: transform var(--gd-motion-duration-short4) var(--gd-motion-easing-standard), filter var(--gd-motion-duration-short4) var(--gd-motion-easing-standard); background: var(--gd-tag-1-bg); color: var(--gd-tag-1-fg); border: 1px solid var(--gd-tag-1-border); }
...
.gd-tag-list { display: flex; flex-wrap: wrap; gap: 10px; }
.gd-tag--item { display: inline-flex; align-items: center; gap: 8px; box-sizing: border-box; height: 30px; padding: 0 18px; background: rgba(var(--gd-color-primary-rgb), 0.08); border: 1px solid rgba(var(--gd-color-primary-rgb), 0.15); border-radius: var(--gd-shape-corner-full); cursor: pointer; font-size: var(--gd-type-label-large-size); font-weight: var(--gd-weight-regular); color: var(--gd-color-on-surface-variant); transition: all 0.25s ease; }
.gd-tag--item:hover { background: rgba(var(--gd-color-primary-rgb), 0.15); border-color: rgba(var(--gd-color-primary-rgb), 0.3); color: var(--gd-color-on-surface); box-shadow: 0 0 16px rgba(var(--gd-color-primary-rgb), 0.12); filter: brightness(1.06); transform: none; }
.gd-tag--item.is-active { background: rgba(var(--gd-color-primary-rgb), 0.2); border-color: var(--gd-color-primary); color: var(--gd-color-primary); }
.gd-tag--item .gd-tag__name { font-weight: var(--gd-weight-semibold); }
.gd-tag--item .gd-tag__count { display: inline-flex; align-items: center; justify-content: center; font-size: var(--gd-type-label-medium-size); color: var(--gd-badge-fg); background: var(--gd-badge-bg); height: 17px; padding: 0 8px; border-radius: 10px; font-weight: var(--gd-weight-bold); line-height: 1; }
.gd-tag--item.is-active .gd-tag__count { color: var(--gd-badge-blue-fg); background: var(--gd-badge-blue-bg); font-weight: var(--gd-weight-bold); }
@media (prefers-reduced-motion: reduce) { .gd-tag { transition: none; } .gd-tag:hover { transform: none; } .gd-tag--item { transition: none; } .gd-tag--item:hover { transform: none; } }

/* ===== src/display/card/gd-card.css ===== */
.gd-card { position: relative; box-sizing: border-box; overflow: hidden; display: flex; flex-direction: column; gap: 14px; width: min(380px, 100%); height: 212px; padding: 20px; border-radius: var(--gd-shape-corner-large); background: var(--gd-glass-bg); backdrop-filter: none; -webkit-backdrop-filter: none; border: 1px solid var(--gd-glass-border); box-shadow: none; color: inherit; text-decoration: none; transition: transform var(--gd-motion-duration-medium1) var(--gd-motion-easing-standard), background var(--gd-motion-duration-medium1) var(--gd-motion-easing-standard), border-color var(--gd-motion-duration-medium1) var(--gd-motion-easing-standard), box-shadow var(--gd-motion-duration-medium1) var(--gd-motion-easing-standard); z-index: 1; }
.gd-card:hover { background: var(--gd-glass-bg-hover); border-color: var(--gd-color-border-hover); box-shadow: 0 0 24px rgba(var(--gd-color-primary-rgb), 0.1), inset 0 1px 0 rgba(var(--gd-color-white-rgb), 0.06); transform: none; filter: brightness(1.05); }
.gd-card--link { cursor: pointer; }
.gd-card__header { display: flex; align-items: flex-start; gap: 14px; }
.gd-card__icon { width: 52px; height: 52px; flex-shrink: 0; border-radius: var(--gd-shape-corner-small); display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, rgba(var(--gd-color-accent-rgb), 0.15), rgba(var(--gd-color-blue-rgb), 0.1)); border: 1px solid rgba(var(--gd-color-accent-rgb), 0.2); font-size: var(--gd-type-title-large-size); font-weight: var(--gd-weight-extrabold); color: var(--gd-color-link); }
.gd-card__icon img { width: 40px; height: 40px; object-fit: contain; }
.gd-card__title-wrap { flex: 1; min-width: 0; }
.gd-card__title { font-size: var(--gd-type-title-medium-size); font-weight: var(--gd-weight-bold); line-height: var(--gd-type-title-medium-line); color: var(--gd-color-on-surface); margin-bottom: 5px; letter-spacing: var(--gd-type-letter-spacing-wide); }
.gd-card__subtitle { font-size: var(--gd-type-body-medium-size); color: var(--gd-color-on-surface-variant); line-height: 1.65; font-weight: var(--gd-weight-regular); display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; min-height: calc(1.65em * 2); }
.gd-card__tags { display: flex; gap: 8px; flex-wrap: wrap; align-items: center; }
.gd-card__actions { display: flex; gap: 10px; margin-top: auto; }
.gd-card__btn { flex: 1; display: inline-flex; align-items: center; justify-content: center; padding: 11px 0; border-radius: 12px; border: none; font-family: var(--gd-font-sans); font-size: var(--gd-type-note-size); font-weight: var(--gd-weight-semibold); letter-spacing: var(--gd-type-letter-spacing-wide); text-align: center; text-decoration: none; cursor: pointer; color: var(--gd-color-on-primary); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
.gd-card__btn--detail { background: linear-gradient(135deg, var(--gd-gradient-primary-a), var(--gd-gradient-primary-b)); box-shadow: none; }
.gd-card__btn--detail:hover { background: linear-gradient(135deg, var(--gd-gradient-primary-hover-a), var(--gd-gradient-primary-hover-b)); filter: brightness(1.06); transform: none; }
.gd-card__btn--link { background: linear-gradient(135deg, var(--gd-gradient-pink-a), var(--gd-gradient-pink-b)); box-shadow: none; }
.gd-card__btn--link:hover { background: linear-gradient(135deg, var(--gd-gradient-pink-hover-a), var(--gd-gradient-pink-hover-b)); filter: brightness(1.06); transform: none; }
.gd-card__btn:focus-visible { outline: 2px solid var(--gd-color-primary); outline-offset: 2px; }
.gd-card__btn.is-disabled { opacity: 0.3; pointer-events: none; cursor: not-allowed; box-shadow: none; }
...
.gd-friend-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 320px)); gap: 18px; justify-content: start; }
.gd-card--item { --gd-comp-item-color: #fbbf24; --gd-comp-item-color-light: #fcd34d; --gd-comp-item-color-rgb: 251, 191, 36; gap: 10px; width: auto; height: auto; padding: 14px 16px; border-radius: 14px; background: rgba(var(--gd-color-white-rgb), 0.035); backdrop-filter: none; -webkit-backdrop-filter: none; border: 1px solid rgba(var(--gd-color-white-rgb), 0.08); box-shadow: none; transform: none; min-width: 0; max-width: 100%; overflow: hidden; transition: background 0.2s var(--gd-motion-easing-standard), border-color 0.2s var(--gd-motion-easing-standard); }
.gd-card--item--demonic { --gd-comp-item-color: #ef4444; --gd-comp-item-color-light: #fca5a5; --gd-comp-item-color-rgb: 239, 68, 68; }
.gd-card--item--immortal { --gd-comp-item-color: #10b981; --gd-comp-item-color-light: #6ee7b7; --gd-comp-item-color-rgb: 16, 185, 129; }
.gd-card--item:hover { background: rgba(var(--gd-color-white-rgb), 0.05); border-color: rgba(var(--gd-comp-item-color-rgb), 0.28); box-shadow: none; transform: none; }
.gd-card--item .gd-card__item-main { display: flex; gap: 12px; align-items: flex-start; min-width: 0; width: 100%; }
.gd-card--item .gd-card__num { min-width: 28px; padding-top: 4px; text-align: center; font-weight: var(--gd-weight-bold); font-variant-numeric: tabular-nums; font-size: var(--gd-type-title-small-size); line-height: 1.4; flex-shrink: 0; color: var(--gd-comp-item-color); }
.gd-card--item .gd-card__item-body { flex: 1; min-width: 0; display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 8px 10px; align-items: start; }
.gd-card--item .gd-card__item-name { grid-column: 1; grid-row: 1; min-width: 0; }
.gd-card--item .gd-card__name-main { display: block; min-width: 0; color: var(--gd-color-on-surface); font-weight: var(--gd-weight-semibold); font-size: var(--gd-type-title-small-size); line-height: 1.4; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.gd-card--item .gd-card__name-sub { display: block; margin-top: 3px; color: var(--gd-color-on-surface-subtle); font-size: var(--gd-type-label-medium-size); font-weight: var(--gd-weight-regular); line-height: 1.45; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; }
.gd-card--item .gd-card__item-actions { display: contents; }
.gd-card--item .gd-card__action-group { display: inline-flex; flex-wrap: wrap; gap: 6px; align-items: center; flex-shrink: 0; }
.gd-card--item .gd-card__action-group--primary { grid-column: 2; grid-row: 1; align-self: center; }
.gd-card--item .gd-card__action-group--ext { grid-column: 1 / -1; grid-row: 2; width: 100%; }
.gd-card__action { display: inline-flex; align-items: center; justify-content: center; min-height: 28px; padding: 0 10px; border-radius: 8px; font-size: var(--gd-type-label-medium-size); font-weight: var(--gd-weight-semibold); text-decoration: none; border: 1px solid transparent; cursor: pointer; white-space: nowrap; user-select: none; transition: background 0.2s var(--gd-motion-easing-standard), border-color 0.2s var(--gd-motion-easing-standard), color 0.2s var(--gd-motion-easing-standard), transform 0.15s var(--gd-motion-easing-standard); }
...
.gd-card__action--site { background: rgba(var(--gd-color-sky-blue-rgb), 0.16); border-color: rgba(var(--gd-color-sky-blue-rgb), 0.42); color: var(--gd-tag-2-fg); }
.gd-card__action--site:hover { background: rgba(var(--gd-color-sky-blue-rgb), 0.26); color: var(--gd-color-link-hover); }
.gd-card__action--detail { background: rgba(var(--gd-color-white-rgb), 0.07); border-color: rgba(var(--gd-color-white-rgb), 0.2); color: rgba(var(--gd-color-muted-white-rgb), 0.96); }
.gd-card__action--detail:hover { background: rgba(var(--gd-color-white-rgb), 0.12); border-color: rgba(255, 255, 255, 0.28); }
.gd-card__action--ext { background: rgba(var(--gd-comp-item-color-rgb), 0.12); border-color: rgba(var(--gd-comp-item-color-rgb), 0.36); color: var(--gd-comp-item-color-light); }
.gd-card__action--ext:hover { filter: brightness(1.1); }
@media (min-width: 769px) { .gd-card--item { flex-direction: row; align-items: center; padding: 16px 18px; gap: 16px; } .gd-card--item .gd-card__item-main { flex: 1; align-items: center; } .gd-card--item .gd-card__num { padding-top: 0; } .gd-card--item .gd-card__item-body { display: flex; flex-direction: row; align-items: center; justify-content: space-between; gap: 16px; } .gd-card--item .gd-card__item-name { flex: 1; min-width: 0; } .gd-card--item .gd-card__item-actions { display: inline-flex; flex-direction: row; align-items: center; flex-shrink: 0; gap: 0; } .gd-card--item .gd-card__action-group--primary { grid-column: auto; grid-row: auto; align-self: center; } .gd-card--item .gd-card__action-group--ext { grid-column: auto; grid-row: auto; width: auto; flex-shrink: 0; margin-left: 14px; padding-left: 14px; border-left: 1px solid rgba(var(--gd-color-white-rgb), 0.1); } .gd-card--item .gd-card__name-main { font-size: var(--gd-type-body-large-size); } }
@media (max-width: 768px) { .gd-card--item { padding: 12px; } .gd-card--item .gd-card__num { min-width: 24px; font-size: var(--gd-type-label-large-size); } .gd-card--item .gd-card__name-main { font-size: var(--gd-type-label-large-size); } .gd-card__action { min-height: 32px; padding: 0 9px; } }
@media (max-width: 640px) { .gd-card { width: 100%; } }
.gd-item-list { display: grid; gap: 10px; min-width: 0; }
@media (prefers-reduced-motion: reduce) { .gd-card, .gd-card__btn, .gd-card__action, .gd-tag { transition: none; } .gd-card__btn:hover, .gd-card__action:hover, .gd-tag:hover { transform: none; } }

/* ===== src/foundation/layout/gd-footer.css ===== */
.gd-footer { text-align: center; padding: 28px 16px 40px; color: rgba(var(--gd-color-muted-white-rgb), 0.45); font-size: var(--gd-type-note-size); font-weight: var(--gd-weight-regular); line-height: 1.7; letter-spacing: var(--gd-type-letter-spacing-normal); font-family: var(--gd-font-sans); }
...
.gd-footer__nav a { color: rgba(var(--gd-color-muted-white-rgb), 0.62); text-decoration: none; font-size: var(--gd-type-note-size); font-weight: var(--gd-weight-medium); padding: 4px 8px; min-height: 24px; }
...
.gd-overview__content .gd-link { color: var(--gd-color-link); text-decoration: none; font-weight: var(--gd-weight-semibold); }
.gd-overview__content .gd-link:hover { text-decoration: underline; text-underline-offset: 4px; }
...
@media (max-width: 640px) { .gd-overview__content .gd-card { width: 100%; } }
