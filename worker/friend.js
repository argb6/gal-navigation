...
async function renderLinks(env) {
  ...
  } catch { return '<div class="card"><ul><li>友链数据暂时不可用。</li></ul></div>'; }
}
...
function renderCard(f) {
  ...
  const icon = f.favicon_url && isSafeUrl(f.favicon_url) ? '<img src="' + escapeAttr(f.favicon_url) + '" alt="' + name + '" loading="lazy" width="22" height="22">' : '<span aria-hidden="true">' + name.charAt(0) + '</span>';
...
<meta name="description" content="GALNAVI 友情链接页面">
<link rel="canonical" href="https://galnavi.top/nav/friend/">
...
<meta property="og:title" content="友情链接 · GALNAVI">
<meta property="og:description" content="GALNAVI 友情链接页面，查看已合作的 ACG 二次元资源站点，申请友链加入我们。">
<meta property="og:url" content="https://galnavi.top/nav/friend/">
<meta property="og:site_name" content="GALNAVI">
<meta property="og:image" content="https://assets.galnavi.top/icon.png">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="友情链接 · GALNAVI">
<meta name="twitter:description" content="GALNAVI 友情链接页面，查看已合作的 ACG 二次元资源站点，申请友链加入我们。">
...
.gd-card__icon img { width: 40px; height: 40px; object-fit: contain; filter: none; forced-color-adjust: none; }
...
/* 友链 */
.gd-card--friend { width: auto; height: 88px; max-width: 320px; }
.gd-card--friend .gd-card__icon { width: 50px; height: 50px; }
.gd-card--friend .gd-card__subtitle { min-height: 0; max-height: 22px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
.gd-friend-grid {
  display: grid;
...
.gd-overview__content .card ul { margin: 6px 0 8px; padding-left: 1.15em; list-style: none; }
.gd-overview__content .card ul li { position: relative; color: var(--gd-color-on-surface-variant); font-size: var(--gd-type-body-large-size); margin-bottom: 12px; line-height: 1.85; padding-left: .15em; }
.gd-overview__content .card ul li::before { content: ""; position: absolute; left: -1em; top: .72em; width: 5px; height: 5px; border-radius: 50%; background: var(--gd-color-primary); }
.gd-overview__content .gd-section__subtitle {
  font-size: var(--gd-type-title-small-size);
  font-weight: var(--gd-weight-semibold);
  color: var(--gd-color-on-surface);
  margin: 12px 0 8px;
  padding-left: 12px;
  border-left: 3px solid var(--gd-color-primary);
}
  ...
  <div class="gd-overview__layout">
    <div class="gd-overview__content">
      <div class="gd-overview-toc-mobile" data-extend-ui-toc>
        <button type="button" class="gd-overview-toc-mobile__btn gd-hamburger-motion" data-extend-ui-toc-toggle aria-expanded="false" aria-controls="friendTocPanel" aria-label="打开本页索引">
        ...
        <div class="gd-overview-toc-mobile__panel" id="friendTocPanel" data-extend-ui-toc-panel aria-hidden="true" hidden>
          <p class="gd-overview-mobile-list__label">本页内容</p>
          <nav class="gd-overview-mobile-list" aria-label="本页索引">
            <a class="gd-overview-mobile-list__link" href="#apply">申请友链</a>
            <a class="gd-overview-mobile-list__link" href="#links">友情链接</a>
          </nav>
        </div>
      </div>
      <h1 class="gd-brand__title gd-brand__title--shift gd-brand__title--demo">友情链接</h1>
      <p class="gd-overview__lede">了解 GALNAVI 的友链申请方式，查看已合作站点。</p>
      <div class="gd-overview__meta">
        <span class="gd-overview__tag">申请友链</span>
        <span class="gd-overview__tag">友情链接</span>
      </div>
      <div class="gd-overview__rule" aria-hidden="true"></div>

      <section class="gd-section" id="apply">
        <h2 class="gd-section__title">申请友链</h2>
        <div class="card">
          <ul>
            <li>本站名称：GALNAVI</li>
      ...
      <section class="gd-section" id="links">
        <h2 class="gd-section__title">友情链接</h2>
        ${linksHtml}
      </section>
    </div>
    <aside class="gd-overview__toc" aria-label="本页内容">
      <nav class="gd-otp" aria-label="本页索引">
        ...
        <div class="gd-otp__list">
          <a class="gd-otp__link" href="#apply">申请友链</a>
          <a class="gd-otp__link" href="#links">友情链接</a>
        </div>
      </nav>
    </aside>
  </div>
