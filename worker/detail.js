...
const DEMO_ROW = {
  title: "示例站点",
  short_desc: "演示用详情页，无真实数据源。",
  tags: "演示,示例",
  md_content: "## 简介\n\n## 官网\n- 官网: https://example.com/alpha\n\n## 资源\n- 网盘",
  category: "websites",
};
export default {
  async fetch() {
    const branches = parseMdContent(DEMO_ROW.md_content);
    const tagList = DEMO_ROW.tags.split(",").map((t) => t.trim()).filter(Boolean);
    const html = renderPage(DEMO_ROW.title, DEMO_ROW.short_desc, tagList, branches, "site-alpha", DEMO_ROW.category);
...
@media (max-width: 768px) {
  ...
  .gd-detail__container { display: block; }
...
<a href="mailto:feedback@galnavi.top">联系站长</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://galnavi.top/nav/donate/">赞助本站</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://galnavi.top/nav/friend/">申请友链</a><span class="gd-footer__sep" aria-hidden="true">|</span><a href="https://galnavi.top/status/">站点状态</a>
</nav>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /* 骨架屏 → 真实内容：cookie 通过后放骨架屏动效，数据就绪后展示完整卡片（palace 同款） */
  (function() {
